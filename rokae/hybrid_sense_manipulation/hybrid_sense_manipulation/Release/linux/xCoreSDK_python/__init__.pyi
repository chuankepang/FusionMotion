...
class BaseRobot:
    ...
    def setDefaultZone(self, zone: float, ec: dict) -> None:
        ...
        Args:
             zone (double): 转弯区半径大小。实际有效范围为0-200。
             ec (dict): 错误码。若操作失败,错误码将被设置为相应的错误信息。
        """
...
class MotionControlMode:
    ...
    __members__: typing.ClassVar[dict[str, MotionControlMode]]  # value = {'Idle': <MotionControlMode.Idle: 0>, 'NrtCommandMode': <MotionControlMode.NrtCommandMode: 1>, 'NrtRLTask': <MotionControlMode.NrtRLTask: 2>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
